...
function App() {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        ...
        const response = await axios.post("http://127.0.0.1:8000/enter_name_surname/", {first_name:first_name,last_name:last_name});
        ...
        if (response.status === 200) {
          ...
          alert(`Updated_data: ${JSON.stringify(updatedData)}`);
